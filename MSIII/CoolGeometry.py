...
def shoot_astro_ray(pos_a, pos_b):
    ...
    if (math.dist(move_pnt, pos_b) < MIN_MARCH_DIST): # if it got real close to B
        return total_dist_moved
    return -1 # otherwise it must have hit Earth



# some debug garbage, ignore
# sat = [24900.4566971705, 16837.114570163412, 29678.09236893334]
# poi = [6382.239829671205, 28.870697150363046, 103.04950350931573]
# print(shoot_astro_ray(sat, poi))

# print(math.dist(sat, poi))
# print(math.dist([0, 0, 0], sat))
# print(math.dist([0, 0, 0], poi))
# print(dot_product(sat, poi) / (math.dist([0, 0, 0], sat) * math.dist([0, 0, 0], poi)))
