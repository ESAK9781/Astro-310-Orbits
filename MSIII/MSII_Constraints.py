...
class MSII_Orbit_Viability_Summary:
...
class MSII_Concise_Constellation_Summary:
    def __init__(self, orbit : MSII_Orbit_Viability_Summary, budget : MSII_Budget_Summary,
                 volume : MSII_Volume_Summary):
...
class MSII_Comprehensive_Constellation_Summary:
    def __init__(self, orbit : MSII_Orbit_Viability_Summary, budget: MSII_Budget_Summary,
                 cover : MSII_Coverage_Summary, volume : MSII_Volume_Summary):
        self.orbit = orbit
        self.budget = budget
        self.cover = cover
        self.volume = volume
        self.concise = MSII_Concise_Constellation_Summary(self.orbit, self.budget, self.volume)
